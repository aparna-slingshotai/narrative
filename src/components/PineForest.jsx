...
export default function PineForest() {
  ...
  const colors = useControls('Pines', {
    foliage: folder({
      colorDark:  { value: '#4a3d8f', label: 'shadow' },
      colorMid:   { value: '#8678c7', label: 'mid' },
      colorLight: { value: '#c9bce4', label: 'highlight' },
    }),
    autumnFoliage: folder({
      autumnDark:  { value: '#5a72b5', label: 'shadow' },
      autumnMid:   { value: '#7d8fc9', label: 'mid' },
      autumnLight: { value: '#b3c1e3', label: 'highlight' },
    }),
    trunkColor: { value: '#5d4f9c', label: 'trunk' },
    ...
    () =>
      new THREE.ShaderMaterial({
        ...
        uniforms: {
          ...
          uColorDark: { value: new THREE.Color('#4a3d8f') },
          uColorMid: { value: new THREE.Color('#8678c7') },
          uColorLight: { value: new THREE.Color('#c9bce4') },
          uFogColor: { value: new THREE.Color('#ece5f5') },
          uFogNear: { value: 8 },
          uFogFar: { value: 22 },
        },
      }),
    ...
    () =>
      new THREE.ShaderMaterial({
        ...
        uniforms: {
          ...
          uHasBrush: { value: 0 },
          uAlphaThreshold: { value: 0.15 },
          uColorDark: { value: new THREE.Color('#5a72b5') },
          uColorMid: { value: new THREE.Color('#7d8fc9') },
          uColorLight: { value: new THREE.Color('#b3c1e3') },
          uFogColor: { value: new THREE.Color('#ece5f5') },
          uFogNear: { value: 8 },
          uFogFar: { value: 22 },
        },
  ...
  const trunkMaterial = useMemo(
    () =>
      new THREE.ShaderMaterial({
        ...
        uniforms: {
          uTrunkColor: { value: new THREE.Color('#5d4f9c') },
          uFogColor: { value: new THREE.Color('#ece5f5') },
          uFogNear: { value: 8 },
          uFogFar: { value: 22 },
        },
